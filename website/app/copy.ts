...
export const WebsiteCopy = {
  en: {
    ...
    chooseGoal: 'Choose by goal',
    oneDestination: 'One destination for each question.',
    apiQuestion: 'What does this API do?',
    taskQuestion: 'How do I complete a task?',
    designQuestion: 'Why is it designed this way?',
    architecturePreview: 'Architecture preview',
    architectureTitle: 'Facts flow inward; adapters stay at the edge.',
    architectureBody:
      'Start with runtime-neutral foundations, then choose the integration boundary that matches your environment.',
    layerMap: 'View the layer map →',
  ...
  zh: {
    ...
    chooseGoal: '按目标选择',
    oneDestination: '每个问题都有明确入口。',
    apiQuestion: '这个 API 能做什么？',
    taskQuestion: '如何完成一个具体任务？',
    designQuestion: '为什么要这样设计？',
    architecturePreview: '架构预览',
    architectureTitle: '事实向内流动，适配器留在边缘。',
    architectureBody: '从运行时无关的基础层开始，再选择与你的环境匹配的集成边界。',
    layerMap: '查看分层地图 →',
    libraryIndex: '类库索引',
